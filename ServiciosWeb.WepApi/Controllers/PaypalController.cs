       ...
       public ActionResult PaymentWithCreditCard()
        {
            ...
            crdtCard.cvv2 = "000";
            crdtCard.expire_month = 9;
            crdtCard.expire_year = 2024;
            crdtCard.first_name = "Jhon";
            crdtCard.last_name = "Doe";
            crdtCard.number = "4032035449176825";
            crdtCard.type = "visa";
        ...
        public ActionResult PaymentWithPaypal()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(payerId))
                {
                   ...
                   // string baseURI1 = "http://localhost:58563/Paypal/PaymentWithPayPal?";
